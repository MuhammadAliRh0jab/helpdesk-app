...
<body class="text-white gradient">
    ...
    <section class="bg-white py-5">
        <div class="card-account text-center py-5 mb-5 text-dark">
            ...
            <button class="btn btn-primary text-white fw-bold rounded-pill my-4 px-4 py-2 shadow" onclick="window.location.href='{{ route('login') }}'" data-aos="fade-up" data-aos-duration="3000" style="width: 10cm; height: 2cm; font-size: 25px;">
                Buat Akun
            </button>
        </div>
    </section>
