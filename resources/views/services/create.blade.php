...
<body class="bg-gray-100 dark:bg-gray-900 p-6">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Tambah Layanan</h1>
    ...
    <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg bg-white dark:bg-gray-800 p-6 rounded shadow dark:shadow-gray-700">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="svc_name" name="svc_name" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-indigo-300 dark:focus:border-indigo-600 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600 focus:ring-opacity-50 dark:bg-gray-900 dark:text-gray-200" required>
        </div>
        <div class="mb-4">
            <label for="category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Kategori</label>
            <select id="category_id" name="category_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-indigo-300 dark:focus:border-indigo-600 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600 focus:ring-opacity-50 dark:bg-gray-900 dark:text-gray-200" required>
        ...
        <div class="mb-4">
            ...
            <select id="status" name="status" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-indigo-300 dark:focus:border-indigo-600 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600 focus:ring-opacity-50 dark:bg-gray-900 dark:text-gray-200" required>
                <option value="active" selected>Active</option>
                <option value="inactive">Inactive</option>
            </select>
        </div>
        <div class="mb-4">
            <label for="svc_desc" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Deskripsi (Opsional)</label>
        ...
        <div class="mb-4">
            <label for="svc_icon" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ikon Layanan (Opsional)</label>
        ...
        <div class="mb-4">
            <label for="allow_guest" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Izinkan Tamu Membuat Laporan</label>
            <input type="checkbox" id="allow_guest" name="allow_guest" class="mt-1 h-4 w-4 border-gray-300 dark:border-gray-700 rounded text-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" value="1">
            <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Aktifkan untuk kategori Publik saja</span>
        </div>
