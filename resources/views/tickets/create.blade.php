                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg shadow-sm" id="title" name="title" placeholder="Masukkan Judul Aduan" value="{{ old('title') }}" required>
                                        @error('title')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control shadow-sm" id="description" name="description" rows="6" placeholder="Masukkan Deskripsi Aduan" required>{{ old('description') }}</textarea>
                                        @error('description')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="dropzone-container p-4 text-center border border-dashed rounded-3 bg-light" @click="$refs.fileInput.click()">
                                            ...
                                            <input type="file" name="images[]" id="images" multiple class="d-none" x-ref="fileInput" @change="updateFileNames">
                                        </div>
                                        @error('images')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="d-flex justify-content-between gap-3 mt-4">
                                        <button type="button" @click="showServices = true; selectedService = null; selectedUnit = null" class="btn btn-outline-secondary btn-lg px-4">
