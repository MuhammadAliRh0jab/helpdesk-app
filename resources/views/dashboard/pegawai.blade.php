        ...
        <div class="content">
            <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
                <div class="flex-grow-1 mb-1 mb-md-0">
                    ...
                    <h2 class="h6 fw-medium text-muted mb-0">Selamat Datang, <a class="fw-semibold" href="javascript:void(0)">{{ Auth::user()->name }}</a>, 👋😊!</h2>
                </div>
            </div>
        </div>
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <ul class="nav nav-tabs" id="dashboardTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="creator-tab" data-bs-toggle="tab" href="#creator" role="tab">Sebagai Pembuat Tiket</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="handler-tab" data-bs-toggle="tab" href="#handler" role="tab">Sebagai Pelaksana Tiket</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-pane fade show active" id="creator" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-xxl-4 d-flex flex-column">
                                        <div class="block block-rounded flex-grow-1 d-flex flex-column">
                                            <div class="block-header block-header-default">
                                                <h3 class="block-title fs-sm text-uppercase">Distribusi Status Tiket (Pembuat)</h3>
                                                <div class="block-options">
                                                    <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                                                        <i class="si si-refresh"></i>
                                                    </button>
                                    ...
                                    <div class="col-xl-12 col-xxl-12">
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo" onclick="loadRecentTickets()">
                                                        <i class="si si-refresh"></i>
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo" onclick="setupHandlerTicketDistributionChart()">
                                                        <i class="si si-refresh"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="block-content block-content-full">
                                                <div style="position: relative; width: 100%; max-width: 240px; height: 240px; margin: 0 auto;">
                                            ...
                                            <div class="block-content bg-body-light pt-2 pb-3">
                                                <div class="row items-push text-center">
                                                    <div class="col-6">
                                                        <div class="fs-xs fw-semibold text-uppercase text-muted mb-1">Belum Selesai</div>
                                                        <div class="fs-4 fw-bold text-warning" id="handler-pending-percent">0%</div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="fs-xs fw-semibold text-uppercase text-muted mb-1">Selesai</div>
                                                        <div class="fs-4 fw-bold text-success" id="handler-completed-percent">0%</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo" onclick="setupResolutionByServiceChart()">
                                                        <i class="si si-refresh"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    ...
                                                    <div class="dropdown d-inline-block" id="assignment-completion-time-range">
                                                        <button type="button" class="btn-block-option dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <i class="fa fa-fw fa-calendar"></i>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)" data-time-range="10year">10 Tahun</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" href="javascript:void(0)" id="assignment-completion-custom-range">Kustom</a>
                                                        </div>
                                                    </div>
                                                    <input type="text" id="assignment-completion-date-picker" class="d-none" placeholder="Pilih Rentang Tanggal">
                                                </div>
                                            </div>
                                            <div class="block-content block-content-full">
                                                <canvas id="assignmentCompletionChart" style="height: 300px;"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo" onclick="loadTicketList()">
                                                        <i class="si si-refresh"></i>
                                                    </button>
                                                </div>
                                            </div>
