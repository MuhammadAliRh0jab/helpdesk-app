...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded shadow dark:shadow-gray-700">
            ...
            <p class="text-2xl text-blue-600 dark:text-blue-400">{{ $ticketStats['assigned'] }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 p-4 rounded shadow dark:shadow-gray-700">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Total Tiket</h3>
            <p class="text-2xl text-gray-600 dark:text-gray-400">{{ $ticketStats['completed'] + $ticketStats['pending'] + $ticketStats['assigned'] }}</p>
        </div>
    </div>

    <div class="bg-white dark:bg-gray-800 p-6 rounded shadow dark:shadow-gray-700">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Distribusi Tiket Anda</h3>
